<template>
  <div class="todo">
    <group>
      <cell title="待办列表">남은{{todoUndo.length}}기사가 완료되지 않았습니다.</cell>
    </group>
    <swipeout>
    ...
    <box gap="10px">
      <x-button type="primary"
                @click.native="addTodo">추가 완료</x-button>
    </box>
    <div v-transfer-dom>
      <popup v-model="popShow" position="bottom" max-height="50%">
        ...
        <div style="padding: 15px;">
          <x-button @click.native="editTodos" plain type="primary">변경 확인</x-button>
        </div>
      </popup>
    </div>
  </div>
